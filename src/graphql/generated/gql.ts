...
export function graphql(
  source: "query FetchAllBrands {\n  brands {\n    id\n    name\n  }\n}",
): (typeof documents)["query FetchAllBrands {\n  brands {\n    id\n    name\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query FetchAllSearchableProducts {\n  variants(where: {searchable: true}) {\n    ...ProductCardFields\n  }\n}",
): (typeof documents)["query FetchAllSearchableProducts {\n  variants(where: {searchable: true}) {\n    ...ProductCardFields\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query FetchProductsByTag($tag: String!) {\n  variants(where: {product: {tags_every: {name: $tag}}, searchable: true}) {\n    ...ProductCardFields\n  }\n}",
): (typeof documents)["query FetchProductsByTag($tag: String!) {\n  variants(where: {product: {tags_every: {name: $tag}}, searchable: true}) {\n    ...ProductCardFields\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "fragment ProductCardFields on Variant {\n  id\n  name\n  price\n  slug\n  product {\n    id\n    name\n    brand {\n      name\n    }\n  }\n  colors {\n    id\n    slug\n    images {\n      url\n      fileName\n    }\n  }\n  sizes {\n    value\n  }\n}",
