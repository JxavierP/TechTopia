...
export type ColorOption = Entity &
  Node & {
...
export type FetchAllBrandsQuery = {
  __typename?: "Query";
...
export type FetchAllSearchableProductsQuery = {
  __typename?: "Query";
  variants: Array<
    { __typename?: "Variant" } & {
...
export type FetchProductsByTagQuery = {
  __typename?: "Query";
  variants: Array<
    { __typename?: "Variant" } & {
      " $fragmentRefs"?: { ProductCardFieldsFragment: ProductCardFieldsFragment };
...
export type ProductCardFieldsFragment = {
  ...
  colors: Array<{
    ...
    id: string;
    slug?: string | null;
    images: Array<{ __typename?: "Asset"; url: string; fileName: string }>;
  }>;
  sizes: Array<{ __typename?: "SizeOption"; value: string }>;
} & { " $fragmentName"?: "ProductCardFieldsFragment" };
  ...
  definitions: [
    {
      ...
      operation: "query",
      name: { kind: "Name", value: "FetchAllBrands" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<FetchAllBrandsQuery, FetchAllBrandsQueryVariables>;
export const FetchAllSearchableProductsDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchAllSearchableProducts" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            arguments: [
              {
                ...
                value: {
                  ...
                  fields: [
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "searchable" },
  ...
  FetchAllSearchableProductsQuery,
  FetchAllSearchableProductsQueryVariables
>;
export const FetchProductsByTagDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchProductsByTag" },
      variableDefinitions: [
        {
                  ...
                  fields: [
                    {
                      ...
                      value: {
                        ...
                        fields: [
                          {
                            kind: "ObjectField",
                            name: { kind: "Name", value: "tags_every" },
                            value: {
                              kind: "ObjectValue",
                              fields: [
                                {
...
} as unknown as DocumentNode<FetchProductsByTagQuery, FetchProductsByTagQueryVariables>;
