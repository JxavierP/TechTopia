import { Outlet, createRootRouteWithContext, useMatchRoute, useRouterState } from "@tanstack/solid-router";
...
function RootComponent() {
  ...
  return (
    <div class="flex h-screen flex-col overflow-hidden bg-[#f6f6f6] font-lato">
      <Header />
      <div class="flex w-full h-full flex-col items-center overflow-y-auto">
